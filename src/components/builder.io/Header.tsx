...
const Header: React.FC = () => {
  return (
    <header className="flex overflow-hidden flex-wrap gap-7 justify-center items-center py-4 w-full text-3xl tracking-normal leading-none text-center text-primary bg-primary max-md:max-w-full">
      <img
        loading="lazy"
      ...
      />
      <div className="self-stretch my-auto text-on-primary">Parrot Wings</div>
    </header>
  );
};
