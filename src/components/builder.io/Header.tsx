...
const Header: React.FC = () => {
  return (
    <header className="flex overflow-hidden flex-wrap gap-7 justify-center items-center py-4 w-full text-3xl tracking-normal leading-none text-center text-black bg-[#6750A4] max-md:max-w-full">
      <img
        loading="lazy"
