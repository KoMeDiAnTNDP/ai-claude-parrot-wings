...
const Button: React.FC<ButtonProps> = ({ text }) => {
  return (
    <div className="flex overflow-hidden flex-col mt-5 w-full text-sm font-medium tracking-normal leading-none text-center max-md:max-w-full">
      <button type="submit" className="flex overflow-hidden flex-col justify-center w-full text-black whitespace-nowrap bg-[#6750A4] min-h-[40px] rounded-[100px] max-md:max-w-full">
